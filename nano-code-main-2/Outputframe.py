...
{
  "dissertation_title": "从编码代理到通用代理：关于真实世界编码代理与高级代理算法的研究",
  "literature_topic": [
    "编码代理在真实世界中的应用",
    "智能代理的泛化能力",
    "代理架构分析",
  ...
  "experimental_requirements": {
    "code_repository_review": {
      "url": "https://github.com/gusye1234/nano-code",
      "description": "该 GitHub 仓库 nano-code 包含一个编码代理系统的源代码。审查该仓库对于理解当前代码结构、掌握代理的工作原理以及为后续优化实验奠定基础至关重要。",
      "analysis_focus": [
        "代码架构（结构、模块化、工作流程）",
        "代理的运行机制",
        "现有算法及实现细节",
    ...
    "reproduction_tasks": [
      {
        "phase": "初步审查与文档整理",
        "target": "理解并记录代理的工作流程和架构",
        "methodology": "分析代码库及相关文档；生成代码架构分析图"
      },
      {
        "phase": "代理算法研究与对比分析",
        "target": "确定当前代理算法的优缺点",
        "methodology": "调研相关文献并与 nano-code 的方法进行比较；分析并撰写代理架构报告"
      },
      {
        "phase": "优化方案提出与实现",
        "target": "为 nano-code 提出并测试优化方向",
        "methodology": "设计并实现优化方案，评估其性能影响，整理并记录实验结果"
      }
    ],
    "critical_evaluation": {
      "failure_case_study": "记录当前代理架构与工作流程中的任何局限性或失败案例，例如可扩展性问题、响应准确性不足或性能瓶颈。",
      "improvement_directions": [
        "强化代理的决策算法",
        "为可扩展性与可维护性进行代码重构",
        "引入最新的代理架构",
  ...
  "urls": [
    {
      "url": "https://github.com/gusye1234/nano-code",
      "description": "nano-code 的官方代码仓库，需要对其架构、功能及潜在改进空间进行审查。"
    }
  ]
}
